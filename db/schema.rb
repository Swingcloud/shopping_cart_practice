...
ActiveRecord::Schema.define(version: 20161226070634) do
  ...
  create_table "order_change_records", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.integer  "order_id"
